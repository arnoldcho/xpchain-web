...
- [x] Windows x64 지갑 설치/동기화/입출금 검증 완료
- [x] Windows x86 지갑을 x64 PC에서 설치/실행 검증
- [x] Linux, macOS 검증 결과를 사이트 문서 페이지에 반영
- [x] 사용자용 지갑 가이드 최종본 작성 (설치/백업/복구)
...
- [x] 프로덕션 환경변수 체크리스트 문서화
- [x] 재배포/롤백 절차(runbook) 문서화
...
- [x] Staking 페이지 “5분 재가동 가이드” OS별 실행 절차 점검
- [x] Wallet 페이지 검증 정보(해시/검증 명령) 배치 위치와 가독성 최종 점검
- [x] Definition of Done 기준 체크리스트 문서 추가
